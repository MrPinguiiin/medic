<div>
    ...
    <section class="bg-white dark:bg-gray-900 rounded-lg">
        ...
        <div x-data="{
                currentTab : 'sales_form',
                changeTab(tab){
                    this.currentTab = tab
                }
            }"
            x-cloak
            x-on:set-sales-tab.window="changeTab($event.detail)">
            ...
            <div class="flex justify-center text-sm font-medium text-center text-gray-500 border-b border-gray-200 dark:text-gray-400 dark:border-gray-700">
                <ul class="flex flex-wrap -mb-px">
                    <li class="mr-2">
                        <button x-on:click="currentTab = 'sales_form'" :class="currentTab == 'sales_form' ? 'text-blue-600 border-blue-600  dark:text-blue-500 dark:border-blue-500' : 'border-transparent  hover:text-gray-600 hover:border-gray-300 dark:hover:text-gray-300'" class="inline-block p-4 border-b-2 rounded-t-lg">Sales Form</button>
                    </li>
                    <li class="mr-2">
            ...
            {{-- sales form --}}
            <div x-show="currentTab == 'sales_form'" x-cloak class="py-8 px-4 mx-auto w-full lg:py-8">
                <div class=" flex justify-between items-center">
                    <h2 class="mb-4 text-xl font-bold text-gray-900 dark:text-white">Sales Form</h2>
                    {{-- <div>
                ...
                <div class="grid gap-4 md:grid-cols-2 lg:grid-cols-2 lg:gap-6">
                    <div>
                        <span for="sell_date" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Sales Date <span class="text-red-500">*</span></span>
                        <div class="relative w-full">
                            ...
                            <input type="date" wire:model="sell_date" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Select date" required>
                        </div>
                        @error('sell_date')
                    ...
                    <div>
                        <label for="seller_name" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Seller Name <span class="text-red-500">*</span></label>
                        <input wire:model="seller_name" required id="seller_name" class="flex w-full bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Input Seller Name" required/>
                    </div>
                </div>
                <div class="flex items-end justify-end dark:bg-slate-900">
                    <button type="submit" wire:click="appendNewSales()" wire:loading.attr="disabled" wire:loading.class="bg-indigo-400 opacity-50" wire:target="appendNewSales" class="inline-flex mx-2 items-center px-5 py-3 mt-4 sm:mt-6 text-sm font-medium text-center text-white bg-indigo-700 rounded-lg focus:ring-4 focus:ring-indigo-200 dark:focus:ring-indigo-900 hover:bg-indigo-800">
                    Next Step
                    </button>
                </div>
            </div>
            ...
            <div x-show="currentTab == 'medicine_form'" x-cloak class="py-8 px-4 mx-auto w-full lg:py-8">
                <div>
                    ...
                    <div class="grid gap-y-4">
                        <div class="grid gap-4 md:grid-cols-2 lg:grid-cols-3 lg:gap-6 dark:bg-slate-800 px-2 py-4">
                            <div>
                                <span for="name" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Medicine Name <span class="text-red-500">*</span></label>
                                <div class="flex">
                                    <select wire:model="name" required id="name" class="flex w-full bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500">
                            ...
                            <div class="w-full">
                                <label for="stock" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Quantity <span class="text-red-500">*</span></label>
                            ...
                            <div class="w-full">
                                ...
                                <div class="relative">
                                    ...
                                    <input type="number" value="" wire:model="selling_price" id="selling_price" class="block w-full p-2.5 pl-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="" required>
                                </div>
                                @error('selling_price')
                                <span class="block text-red-500 text-sm">{{ $message }}</span>
                                @enderror
                            ...
                            <div class="w-full">
                                <span for="expired" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Expired <span class="text-red-500">*</span></span>
                                <div class="relative w-full">
                                    <div class="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
                                        <svg class="w-4 h-4 text-gray-500 dark:text-gray-400" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
                                            <path d="M20 4a2 2 0 0 0-2-2h-2V1a1 1 0 0 0-2 0v1h-3V1a1 1 0 0 0-2 0v1H6V1a1 1 0 0 0-2 0v1H2a2 2 0 0 0-2 2v2h20V4ZM0 18a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2V8H0v10Zm5-8h10a1 1 0 0 1 0 2H5a1 1 0 0 1 0-2Z"/>
                        ...
                        <div class="flex items-end justify-between mt-2">
                            ...
                            <div>
                                <x-secondary-button class="py-3 mx-1 capitalize" wire:click="clearNewSalesForm">
                                    Clear
                                </x-secondary-button>
            ...
            <div x-show="currentTab == 'summary'" x-cloak class="py-8 px-4 mx-auto w-full lg:py-8">
                <div class="grid gap-4 md:grid-cols-2 lg:grid-cols-2 lg:gap-6">
                    <div class="w-full">
                        <label for="total_sales" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Total Sales (filled automatically)<span class="text-red-500">*</span></label>
                        <div class="relative">
                            <div class="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
                                <span class="w-4 text-gray-500 dark:text-gray-400">Rp.</span>
                            </div>
                            <input type="number" wire:model="total_sales" disabled id="total_sales" class="block w-full p-2.5 pl-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="" required>
                        </div>
                    </div>
                    <div>
                        <span for="invoice" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Invoice <span class="text-red-500">*</span></label>
                        <div class="flex">
                            <input type="text" wire:model="invoice" disabled name="invoice" id="invoice" class="flex w-full bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="invoice will be filled after sales created" required="">
                                ...
                                @if($newMedicines != null)
                                    @forelse ($newMedicines as $k => $n_medicine)
                                        <tr class="bg-white border-b dark:bg-gray-900 dark:border-gray-700">
                                            ...
                                            <td class="px-6 py-4">
                                                <button wire:click="unsetASales({{ json_encode($sales) }})" wire:loading.class="text-indigo-400 opacity-50" wire:target="unsetAMedicine" type="button" class="font-medium text-blue-600 dark:text-blue-500 hover:underline">Delete</button>
                                            </td>
                                        </tr>
                                    @empty
                                    <tr>
                ...
                <div class="flex items-end justify-end dark:bg-slate-900">
                    <button type="submit" wire:click.prevent="saveMedicineSales()" wire:loading.attr="disabled" wire:loading.class="bg-indigo-400 opacity-50" wire:target="saveMedicinePurchase" class="inline-flex mx-2 items-center px-5 py-3 mt-4 sm:mt-6 text-sm font-medium text-center text-white bg-indigo-700 rounded-lg focus:ring-4 focus:ring-indigo-200 dark:focus:ring-indigo-900 hover:bg-indigo-800">
                        Save Sales and All Medicines
                    </button>
                </div>
            </div>
    ...
    <x-modal x-data name="add-supplier" focusable>
        <div class="bg-gray-50 dark:bg-gray-900 shadow-md rounded-lg py-2 px-4 h-fit">
            ...
            <form class="p-4" wire:submit="saveSupplier" @submit.prevent="show = false">
                ...
                <div class="relative z-0 w-full mb-6 group p-2">
                    <span type="text" name="description" id="description" wire:model="supplierAddress" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
